    ...
    <div className="GameBoard">
      <div className="GameBoard-Row1">
        <div className="GameBoard-ColorHouse GameBoard-Red">
          <div className="House-Pieces">
            { game.players[0].pieces.map(p => p.atHome && <Piece color={colors[0]} piece={p} />) }
          </div>
        </div>
        ...
        <div className="GameBoard-ColorHouse GameBoard-Yellow">
          <div className="House-Pieces">
            { game.players[1].pieces.map(p => <Piece color={colors[1]} piece={p} />) }
          </div>
        </div>
      </div>
      ...
      <div className="GameBoard-Row3">
          <div className="GameBoard-ColorHouse GameBoard-Green">
            <div className="House-Pieces">
              { game.players.length > 2 && game.players[2].pieces.map(p => <Piece color={colors[2]} piece={p} />) }
            </div>
          </div>
          <div className="GameBoard-Col">
          ...
          <div className="GameBoard-ColorHouse GameBoard-Blue">
            <div className="House-Pieces">
              { game.players.length === 4 && game.players[3].pieces.map(p => <Piece color={colors[3]} piece={p} />) }
            </div>
          </div>
      </div>
    </div>
